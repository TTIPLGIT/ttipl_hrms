...
const tableName = "Opened Requirements";
...
export default function OpenRequirements() {
  ...
  const actions = [
    {
      ...
      command: () => {
        navigate("/open_requirements/edit", {
          state: { id: row?.id },
        });
      },
    },
    {
      ...
      icon: "pi pi-eye",
      command: () => {
        navigate("/open_requirements/view", {
          state: { id: row?.id },
        });
      },
    },
          ...
          accept: async () => {
            try {
              ...
              const data = await protectedCall(
                "api/requirement/open/requirements"
              );
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const data = await protectedCall("api/requirement/open/requirements");
